...
//var left_inside_wing2 = document.querySelector('.left_inside_wing');
   ...
   var left_wing = Snap('#left_wing');
    ...
    left_inside_wing.animate({fill:'#ffffff',stroke:'white'},600); right_inside_wing.animate({fill:'#ffffff',stroke:'white'},600);
  
  left_wing.animate({stroke:'white'},500);
  right_wing.animate({stroke:'white'},500);
...
//  
    ...
    Snap.animate(top_left_wing.attr('points'), [0,0,150,0 ,0,150],
        function (val) { top_left_wing.attr({ points: val }) }, 500, mina.easeout, fold_right_top_wing);
   top_left_wing.animate({stroke:'white'},550);
//
}
...
fold_right_top_wing = function () {
    ...
    Snap.animate(top_right_wing.attr('points'), [150,0, 300,0 ,300,150],
        function (val) { top_right_wing.attr({ points: val }) }, 500, mina.linear, fold_left_bottom_wing);
  top_right_wing.animate({stroke:'white'},550);
}
...
fold_left_bottom_wing = function () {
    ...
    Snap.animate(left_bottom.attr('points'), [0,150, 150,150 ,150,190 ,0,190],
        function (val) { left_bottom.attr({ points: val }) }, 500, mina.linear, fold_right_bottom_wing);
...
fold_right_bottom_wing = function () {
    ...
    Snap.animate(right_bottom.attr('points'), [150,150, 300,150 ,300,190,150,190],
        function (val) { right_bottom.attr({ points: val }) }, 500, mina.linear);
