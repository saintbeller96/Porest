...
const fold_right_top_wing = () => {
  var top_right_wing = Snap('#top_right_wing');
  Snap.animate(
    top_right_wing.attr('points'),
    [150, 0, 300, 0, 300, 150],
    function(val) {
      top_right_wing.attr({
        points: val,
...
const fold_left_bottom_wing = () => {
  var left_bottom = Snap('#left_bottom');
  Snap.animate(
    left_bottom.attr('points'),
    [0, 150, 150, 150, 150, 190, 0, 190],
    function(val) {
      left_bottom.attr({
        points: val,
      });
    ...
    500,
    mina.linear,
    fold_right_bottom_wing,
  );
  //   left_bottom.animate({stroke:'white'},200);
};

const fold_right_bottom_wing = () => {
  var right_bottom = Snap('#right_bottom');
  Snap.animate(
    right_bottom.attr('points'),
    [150, 150, 300, 150, 300, 190, 150, 190],
    function(val) {
      right_bottom.attr({
        points: val,
      });
