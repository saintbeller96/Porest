<template>
  <div class="home-wrapper">
    <div class="paper-plane">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95.04 61.39">
        ...
        <div class="container">
          <div class="form">
            ...
            <form>
              ...
              <p class="forget">Don't you have a account?<a href="#">Sign up</a></p>
            </form>
          </div>
        </div>
      </div>
...
.paper-plane {
  ...
  width: 50px;
  height: 50px;
  animation: paper1 8s ease-in-out infinite;
}
