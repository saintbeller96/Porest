    ...
    <div class="letter">
      <form class="mailform">
        ...
        <div>
          ...
          <input type="text" name="emailadress" size="40" placeholder="Email adress">
        </div>
        <div>
...
<script>
import { init } from '@/assets/js/mail/RootMailReply.js'
export default {
    name:'RootMailReply',
    mounted(){
        init()
...
<style scoped src='@/assets/css/mail/RootMailReply.css'>
