...
<script>
import { init } from '@/assets/js/CommingsoonPage.js';
export default {
  data() {
    return {
      count: 5,
...
<style scoped src="@/assets/css/CommingsoonPage.css">
.container {
  overflow: hidden;
}
</style>
